...
def run_demo(net, image_provider, height_size, cpu, track, smooth):
  ...
  for img in image_provider:
    ...
    for pose in current_poses:
      if pose.id not in data_points:
        data_points[pose.id] = []
      data_points[pose.id].append({"time": time.time(), "keypoints": pose.keypoints.tolist()})
...
if __name__ == '__main__':
  ...
  parser.add_argument('--video', type=str, default="https://www.youtube.com/watch?v=HVaeORt4e-w",
  ...
  try:
    ...
    print("Keyboard Interrupted... do the storing work")
